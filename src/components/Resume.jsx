...
export default function Resume() {
  ...
  return (
    <div
      className={` ${background} mt-6 mx-auto py-3 px-4 flex justify-between items-center rounded-[4px] text-white md:py-8 md:px-10 md:rounded-lg lg:mt-[50px] lg:px-[60px] lg:rounded-2xl lg:py-[45px]`}
    >
