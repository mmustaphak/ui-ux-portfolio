export default function Resume() {
  return (
    <div className="mt-6 mx-auto py-3 px-4 flex justify-between items-center rounded-[4px] text-white bg-black md:py-8 md:px-10 md:rounded-lg lg:px-[60px] lg:rounded-2xl lg:py-[45px]">
      ...
      <button className="py-0.5 px-[23px] w-full max-w-[110px] min-[375px]:max-w-[130px] rounded-[2.14px] text-[6.43px] font-medium border border-white md:border-2 md:px-0 md:rounded-md md:text-xl md:py-1 md:max-w-[280px] lg:text-[1.25rem] lg:py-[10px] lg:max-w-[409px] lg:border-3 lg:text-2xl lg:rounded-lg ">
        Download Resume
      </button>
    </div>
  );
